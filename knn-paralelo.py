...
dataset_path = f"datasets2/{dataset_name}"
...
# ============== SPLIT TEST DATA ==============
local_X_test = comm.scatter(np.array_split(X_test, size) if rank == 0 else None, root=0)
local_y_test = comm.scatter(np.array_split(y_test, size) if rank == 0 else None, root=0)
